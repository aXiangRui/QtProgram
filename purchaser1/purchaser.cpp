...
void Purchaser::initUI()
{
    ...
    formLayout->addRow("用户名:", loginUsername);
    formLayout->addRow("密码:", loginPassword);
    ...
    regConfirmPassword->setMaximumWidth(300);

    regFormLayout->addRow("用户名:", regUsername);
    regFormLayout->addRow("密码:", regPassword);
    regFormLayout->addRow("确认密码:", regConfirmPassword);
